...
public class Attribute extends AbstractAttribute {
	...
	public Attribute(String name, Integer type, String dictionary,
			Integer importType, String importName, String importDateDay,
			String importDateMonth, String importDateYear, String userLabel,
			Integer length, ObjectType objType) {
	...
	public List loadContainingCompoundAttributes(Session session) {
		Query query = session
				.createQuery("from CompoundAttribute a where :attr = some elements(a.attributes)");
