...
public class MapBean {
	...
	private void setMapData() {
		...
		if (this.neededQuery) {
			...
			conditions.addCondition(Voyage.getAttribute("yearam"), new Integer(MARKERS[this.yearBegin.intValue()]), Conditions.OP_GREATER_OR_EQUAL);
			conditions.addCondition(Voyage.getAttribute("yearam"), new Integer(MARKERS[this.yearEnd.intValue()]), Conditions.OP_SMALLER_OR_EQUAL);
