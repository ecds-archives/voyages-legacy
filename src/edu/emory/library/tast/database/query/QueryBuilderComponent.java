 ...
 * with the bean {@link edu.emory.library.tast.database.query.SearchBean} via the currently
 * built quuery, represented by {@link edu.emory.library.tast.database.query.QueryBuilderQuery}. When
