...
public class Slave extends AbstractDescriptiveObject {
	...
	static {
		...
		types.put("slaveName", "String");
		types.put("sexage", "SexAge");
		types.put("age", "Integer");
		types.put("feet", "Integer");
		types.put("inch", "Integer");
		types.put("ageinf", "Integer");
		types.put("country", "Country");
		types.put("name", "String");
		types.put("unclear", "Integer");
		types.put("nameimp", "String");
		types.put("natimp", "Nation");
		types.put("bodypt1", "BodyPt");
		types.put("placea1", "PlaceA");
		types.put("placeb1", "PlaceB");
		types.put("marksize", "MarkSize");
		types.put("marktype", "MarkType");
		types.put("marknumb", "MarkNumber");
		types.put("markdegr", "MarkDegree");
		types.put("othrmark", "OtherMark");
		types.put("markspec", "SpecialMark");
		types.put("bodypt2", "BodyPt");
		types.put("placea2", "PlaceA");
		types.put("placeb2", "PlaceB");
		types.put("marksiz2", "MarkSize");
		types.put("marktyp2", "MarkType");
		types.put("marknum2", "MarkNumber");
		types.put("markdeg2", "MarkDegree");
		types.put("bodypt3", "BodyPt");
		types.put("placea3", "PlaceA");
		types.put("placeb3", "PlaceB");
		types.put("marksiz3", "MarkSize");
		types.put("marktyp3", "MarkType");
		types.put("marknum3", "MarkNumber");
		types.put("markdeg3", "MarkDegree");
		types.put("bodypt4", "BodyPt");
		types.put("bodypt5", "BodyPt");
		types.put("bodypt6", "BodyPt");
		types.put("placea4", "PlaceA");
		types.put("placea5", "PlaceA");
		types.put("placea6", "PlaceA");
		types.put("placeb4", "PlaceB");
		types.put("placeb5", "PlaceB");
		types.put("placeb6", "PlaceB");
		types.put("marksiz4", "MarkSize");
		types.put("marksiz5", "MarkSize");
		types.put("marksiz6", "MarkSize");
		types.put("marktyp6", "MarkType");
		types.put("marktyp5", "MarkType");
		types.put("marktyp4", "MarkType");
		types.put("marknum4", "MarkNumber");
		types.put("marknum5", "MarkNumber");
		types.put("marknum6", "MarkNumber");
		types.put("markdeg6", "MarkDegree");
		types.put("markdeg5", "MarkDegree");
		types.put("markdeg4", "MarkDegree");
		types.put("majselpt", "Integer");
		types.put("source", "String");
		types.put("majbuypt", "Integer");
		types.put("datarr34", "Integer");
		types.put("regem1", "Integer");
		userLabels.put("iid", "");
		userLabels.put("slaveId", "Slave ID");
		userLabels.put("voyageId", "Voyage ID");
		userLabels.put("slaveName", "Slave name");
		userLabels.put("sexage", "");
		userLabels.put("age", "");
		userLabels.put("feet", "");
		userLabels.put("inch", "");
		userLabels.put("ageinf", "");
		userLabels.put("country", "");
		userLabels.put("name", "");
		userLabels.put("unclear", "");
		userLabels.put("nameimp", "");
		userLabels.put("natimp", "");
		userLabels.put("bodypt1", "");
		userLabels.put("placea1", "");
		userLabels.put("placeb1", "");
		userLabels.put("marksize", "");
		userLabels.put("marktype", "");
		userLabels.put("marknumb", "");
		userLabels.put("markdegr", "");
		userLabels.put("othrmark", "");
		userLabels.put("markspec", "");
		userLabels.put("bodypt2", "");
		userLabels.put("placea2", "");
		userLabels.put("placeb2", "");
		userLabels.put("marksiz2", "");
		userLabels.put("marktyp2", "");
		userLabels.put("marknum2", "");
		userLabels.put("markdeg2", "");
		userLabels.put("bodypt3", "");
		userLabels.put("placea3", "");
		userLabels.put("placeb3", "");
		userLabels.put("marksiz3", "");
		userLabels.put("marktyp3", "");
		userLabels.put("marknum3", "");
		userLabels.put("markdeg3", "");
		userLabels.put("bodypt4", "");
		userLabels.put("bodypt5", "");
		userLabels.put("bodypt6", "");
		userLabels.put("placea4", "");
		userLabels.put("placea5", "");
		userLabels.put("placea6", "");
		userLabels.put("placeb4", "");
		userLabels.put("placeb5", "");
		userLabels.put("placeb6", "");
		userLabels.put("marksiz4", "");
		userLabels.put("marksiz5", "");
		userLabels.put("marksiz6", "");
		userLabels.put("marktyp6", "");
		userLabels.put("marktyp5", "");
		userLabels.put("marktyp4", "");
		userLabels.put("marknum4", "");
		userLabels.put("marknum5", "");
		userLabels.put("marknum6", "");
		userLabels.put("markdeg6", "");
		userLabels.put("markdeg5", "");
		userLabels.put("markdeg4", "");
		userLabels.put("majselpt", "");
		userLabels.put("source", "");
		userLabels.put("majbuypt", "");
		userLabels.put("datarr34", "");
