...
public class Slave extends AbstractDescriptiveObject {
	...
	static {
		...
		types.put("slaveId", new SchemaColumn("slaveId", 1, null, 0, null, null, null, null, "Slave ID"));
		types.put("voyageId", new SchemaColumn("voyageId", 1, null, 0, null, null, null, null, "Voyage ID"));
		types.put("slaveName", new SchemaColumn("slaveName", 2, null, 1, null, null, null, null, "Slave name"));
