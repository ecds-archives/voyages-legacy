...
public class ImportServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		params[0] = logFileName;
		params[1] = voyagesFile != null ? voyagesFile.getServerFileName() : "*";
		params[2] = slavesFile != null ? slavesFile.getServerFileName() : "*";
		
		// run
		JavaProgramRunner javaRunner = new JavaProgramRunner();
	...
	public static void main(String[] args) throws IOException
	{
		...
		// run
		JavaProgramRunner javaRunner = new JavaProgramRunner();
		javaRunner.setStartClass("edu.emory.library.tas.spss.Import");
