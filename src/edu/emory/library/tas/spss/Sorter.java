...
public class Sorter
{
	...
	public Sorter(RecordIOFactory recordIO)
	{
		this.recordIO = recordIO;
	}

	public Sorter(String inputFileName, String outputFileName, RecordIOFactory recordIO)
	{
	...
	public static void main(String[] args) throws IOException
	{
		...
		//Sorter s = new Sorter("voyages.csv", "voyages-sorted.csv", "voyageid");
		//s.setMaxLines(2000);
		//s.sort();
