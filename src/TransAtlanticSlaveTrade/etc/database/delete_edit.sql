-- Function: delete_edit(integer)

-- DROP FUNCTION delete_edit(integer);

CREATE OR REPLACE FUNCTION delete_edit(integer)
  RETURNS boolean AS
$BODY$
DECLARE
	sid ALIAS FOR $1;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION delete_edit(integer) OWNER TO tast;
