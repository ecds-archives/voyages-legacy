-- Function: delete_merge(integer)

-- DROP FUNCTION delete_merge(integer);

CREATE OR REPLACE FUNCTION delete_merge(integer)
  RETURNS boolean AS
$BODY$
DECLARE
	sid ALIAS FOR $1;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION delete_merge(integer) OWNER TO tast;
