INSERT INTO faqs (id, cat_id, question, answer) VALUES (1, 1, 'Where can I get 
help using this website?', '<p>On the right side of the orientation bar beneath 
the top banner, there are links to four different types of online 
assistance:</p><ol><li>a <b>Sitemap</b> showing all areas of the site at a 
glance; </li><li>a list of frequently asked questions and answers 
(<b>FAQs</b>);</li><li>video demonstrations of how to use the website and 
databases (<b>Demos</b>); </li><li>a <b>Glossary</b> of terms used in the study 
of the slave trade. </li></ol><p>Additionally, in the Understanding the Database 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (2, 1, 'How do I find out 
what’s available on this website?', '<p>The five main sections of the website 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (3, 1, 'How do I move 
from one part of the website to another?', '<p>From any page of the website, you 
...
it by means of links in the left frame.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (4, 1, 'What are the 
optimal settings for viewing the website?', '<p>The performance of the Voyages 
...
make extensive use of JavaScript and operate more smoothly on computers not 
...
on the site &ndash; the Voyages Database, the Estimates Database, and the African
Names Database. This license allows for the non-commercial republication of certain
content on the site and the creation of derivate works, provided the <em>Voyages</em>
website is appropriately credited as the original source. Some materials on the
<em>Voyages</em> website, however, appear by permission of the copyright owners and
...
original source, see the "Permissions to Reproduce" section of the "Legal" page.</p>');
...
provide evidence of a slaving voyage. An <b>imputed</b> variable is not 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (6, 2, 'What is the 
difference between basic variables and general variables?', '<p>There are two 
main options for querying the database: a <b>basic</b> search (“Basic 
variables”) uses a smaller set of variables, and a <b>general</b> search 
...
variables available by downloading the full SPSS dataset).</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (7, 2, 'Why is there an 
asterisk (*) next to some variables? ', '<p>Variables with an asterisk are 
...
the assumptions and basis of all imputed variables.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (8, 2, 'Where can I see 
at a glance variables available for analysis in different sections of the 
website?', '<p>Look in the fourth, fifth, and six columns of the Variable List. 
The column “Voyages” shows the number of cases that have information coded for 
each variable in the main database.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (9, 2, 'How can I observe 
the values of a variable?', '<p>For categorical variables, put the variable into 
...
the top and bottom of its range.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (10, 2, 'Where do I find 
bibliographies of studies of the slave trade on the website?', '<p>“Published 
...
studies of the Atlantic slave trade.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (11, 2, 'How do I find 
documentation for a particular voyage?', '<p>Your starting point should be the 
...
be used to bring up the full description of the source.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (12, 3, 'How do I find 
information about a particular slaving voyage?', '<p>“Search the Database” 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (13, 3, 'How do I limit 
queries to specific sets of years?', '<p>“Select time frame” is the first query 
...
single year, specify the same year in both “From” and “To.”</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (14, 3, 'How do I select 
voyages for examination and analysis?', '<p>First, from the set of either basic 
...
match your selection criteria.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (15, 3, 'Is there a way 
to know how many cases in the database have information relevant to a particular 
query?', '<p>Every choice of criteria limits the query to a smaller number of 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (16, 3, 'Why do methods 
of selection differ from variable to variable?', '<p>The method of selection 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (17, 3, 'How do I use 
selection options for numerical variables?', '<p>Numerical variables ask the 
user to choose one of four options and enter a number or numbers after it:</p> 
<ul> <li>Between </li><li>At most </li><li>At least</li><li>is equal to</li> 
</ul> <p>For percentages and rates, enter “At least ‘0’” to limit the query to 
voyages for which such measures can be computed.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (18, 3, 'How does 
“Previous queries” work?', '<p>You can recall the selection criteria in a 
...
the option “Create a link.”</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (19, 3, 'How does “Create 
a link” work?', '<p>“Create a link” appears in the left frame of “Search the 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (20, 3, 'How do I select 
variables of names (of the ship, captain, owners) and sources?', '<p>Click on 
...
sources can be sorted by either short or long reference.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (21, 3, 'How do I control 
for certain variables in analyzing data in other variables in the main database 
and estimates?', '<p>A control variable is one that does not change (or is held 
...
from making a clean start.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (23, 3, 'When I begin a 
...
session remain in effect. How do I begin again from default?', '<p>First, click 
...
browser, clear its cache, and then return to the Voyages website.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (24, 4, 'How do I extend 
the range of variables displayed under the “Results Listing”?','<p>Clicking on 
“Configure columns of the table&gt;” will open a page to choose what to display 
in “List of Voyages.” Variables are listed in the same categories that are used 
throughout the website. Select a variable by clicking first on the category 
under which it is listed in “Choose group of variables” and then on the variable 
itself in “Available variables.” Your choice will be highlighted. Then click on 
the arrow to move it to the “Selected variables” box. Note that you can also 
remove a variable displayed in “List of voyages” by moving it out of the 
selected variables box. Finally, you can set the order of columns for variables 
in “List of Voyages” by clicking on any variable and moving it up or down in the 
selected variables box. When you have finished configuring the list of voyages, 
click on “Apply configuration.” This returns you to the list of voyages where 
you will see variables displayed as you have requested.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (25, 4, 'How do I print 
results?', '<p>One simple way to print results is to use PrtSc (Print Screen). 
For a table or graph that you would like to print, hit the PrtSc key on your 
keyboard. This copies an image of the entire page into memory. Then paste the 
image into a blank screen of an image editing program like Microsoft Paint (one 
of the accessories) or Adobe Photoshop. From this image, you can then select a 
part of the image of an entire page, for example, the title and table of Summary 
Statistics, copy it and paste it into another page which you can print or save. 
Print screen will not supply a title for a table, graph, or map, nor will it 
include sources, notes or the details of the query that produced your results. 
It may be more efficient to download the data into a spreadsheet, construct a 
table or graph there with title, notes, sources, and desired formatting, and 
print this instead.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (26, 5, 'How do I 
interpret information provided in “Summary Statistics”?', '<p>First, you should 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (27, 5, 'How can I use 
“Summary Statistics” in combination with the query frame to the left to compare 
voyages with different characteristics?', '<p>The default for “Search the 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (28, 5, 'What do 
“averages” calculated in Summary Statistics, Tables, and the Timeline mean?', 
'<p>An average is a value that is typical or representative of all values for 
...
variation there is above and below the average.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (29, 5, 'How do I 
determine if a slaving voyage is typical or exceptional?', '<p>Compare 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (30, 6, 'Can the data be 
examined in larger units than single years?', '<p>Using the time frame box in 
the query section, the user can specify periods of any duration, but only one 
period at a time. In the tables tab in both Estimates and Search the Database, 
one can choose to display a number of statistics about the slave trade in 
5-year, 10-year, 25-year , 50-year, and 100-year periods. Click the desired 
period in the selection area for table rows. In custom graphs, choices for the 
x-axis variable include, under voyage dates, year of arrival of slaves by 
5-year, 10-year, and 25-year periods.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (31, 7, 'What can be 
learned by graphing differences observed in tables?', '<p>Graphs can bring to 
...
they are usually not significant.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (32, 7, 'Custom graphs 
offer the possibility to construct three kinds of graphs: XY, pie, and bar 
charts. When should I use each type?', '<p>First, read over the answers to the 
...
relationship, or correlation, between two numerical variables.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (33, 7, 'Is there a 
technique for making effective graphs?', '<p>Remember that a limited number of 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (74, 18, 'Can’t find the 
information you are looking for? ', '<p>Please address unanswered questions to 
<a href="mailto:voyages@emory.edu">voyages@emory.edu</a>, and we 
will attempt to provide this information for you.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (34, 7, 'How do I 
construct a bar chart?', '<p>First, select bar chart as the “Graph type.” 
...
graph is not satisfactory, rethink your specifications.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (35, 7, 'How do I make a 
pie chart?', '<p>A pie chart is a circular graph having radii dividing the 
...
percentages.</p><p>To make a pie chart in Custom Graphs, click on its button 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (36, 7, 'How do I draw an 
XY graph?', '<p>An X-Y chart consists of a line drawn between the co-ordinates 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (37, 8, 'The Voyages 
Database and Estimates both have timelines. How do I use them to observe 
differences over time? Should trends look the same in both sections?', '<p>The 
timeline is a bar graph that functions similarly in Estimates and the Voyages 
Database. The main difference is that it shows only captives embarked and 
disembarked per year in Estimates, while it can describe annual change of a 
larger number of variables in the Voyages Database. For the latter, click on a 
variable in the selection box and then on the button "Show." The timeline for 
Estimates includes a chronology which illustrate how this graphic can be used to 
show the impact of critical events on the slave trade. Moving the cursor from 
left to right in the main graph area causes a bar to appear indicating year, and 
information for that year appears below the timeline. To view a segment of time 
in more detail, click and drag bars on the left and right of the smaller chart 
area below the main chart area to the beginning and end year of the desired 
period. Because estimates take into account voyages for which documentation is 
lacking, the number of embarked and disembarked slaves will be greater in its 
timeline than in the one for the main database, but trends will be similar. 
</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (38, 9, 'What kinds of 
maps are found in the website?', '<p>The map on the home page is a historical 
map in the sense that it is an artifact from the period of the slave trade. It 
is part of the world map <i>Nova totius terrarium orbis geographica ac 
hydrographica tabula</i>, drawn by the Dutch cartographer Willem Janszoon Blaeu 
...
more than 150 that will appear in the <i>Atlas of the Slave Trade</i> that will 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (39, 9, 'Is there any 
difference between maps in the Voyages Database and in Estimates?','<p>The icons 
...
defined somewhat differently in Estimates than in the Voyages Database.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (40, 9, 'How are 
interactive maps affected by selections made in the query frame on the left?', 
'<p>Any change in criteria used to select voyages also changes the 
...
number of slaves represented by dots of different sizes is much smaller.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (41, 9, 'What is the 
function of icons at the top of maps?', '<p>Most of the icons enable the user to 
zoom in or out. As the zoom level changes, so do labels and geophysical or 
historical background.</p><p>At the far left are pointers to the left and right. 
...
level.</p><p>Next, from left to right, are icons of a hand and an empty 
...
release the mouse button.</p><p>The middle icons also allow you to zoom in (+) 
...
provides another way of moving among the four scales.</p><p>Finally, the three 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (42, 9, 'How do I use the 
positioning box in the bottom right corner of interactive maps?', '<p>The area 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (43, 9, 'To the right of 
the map, “Select map” allows the user to choose between broad regions, regions, 
and ports. What is the difference between these units?', '<p>The Atlantic world 
...
information.</p><p>Each broad region contains specific regions. They are defined 
...
regions.</p><p>These categories are the same as those used in the “Voyage 
Itinerary” category in the Voyages Database search interface</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (44, 9, 'What is the 
difference between “visible places” and places labeled on the maps themselves?', 
'<p>Visible places refers to the placement of red and yellow dots on maps. The 
...
the finest zoom level (1).</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (45, 9, '“Select map” 
also allows the user to choose the time period of the map. What is the nature of 
choices offered here?', '<p>First, the user can choose between maps that show 
...
powers, and the period of its abolition and suppression.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (46, 9, 'How does 
selection of an historical map affect the display of data?', '<p>In “Select 
...
of slaves represented by different size dots.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (47, 9, 'Places are 
represented on the map by five different sizes of yellow and red dots? How do I 
interpret these symbols?', '<p>Yellow dots show places of embarkation.  Red dots 
...
disembarkations for the region or location.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (48, 9, 'How is the 
number of slaves embarked and/or disembarked corresponding with different circle 
sizes computed?', '<p>A simple algorithm has been used to classify the number of 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (49, 9, 'In the 
...
disembarkation affect what is displayed on maps?', '<p>Only places with a check 
...
of visible places of embarkation.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (50, 9, 'What is the 
function of “Refresh”?', '<p>Refresh resets the display of dots and time period 
of maps according to the choices made in “Select map” and the check 
boxes.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (51, 9, 'How do I make 
the map center on a particular place?', '<p>“Find visible place,” the tool at 
...
other places at different scales.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (52, 9, 'What features 
are shown on geophysical maps?', '<p>Within land masses, one can see rivers 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (53, 9, 'What kinds of 
detail are displayed on the historical maps?', '<p>In Europe, the area of 
countries were voyages were organized are shaded. Except for Spain, labels of 
the names of slave trading nations are placed off adjacent coastlines.</p><p>In 
...
refer.</p><p>In the Central and South American historical maps of regions and 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (54, 10, 'Can I download 
results for further analysis using a spreadsheet?', '<p>Yes, there are buttons 
on most pages for downloading information or results from the page in a csv 
(comma delimited file). Simply click on the button. It will transfer the data 
file to your computer where you can import it into a spreadsheet program of your 
choice.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (55, 10, 'What parts of 
the <i>Voyages</i> website can I download? How?', '<p>First, you can download 
any PDF file. Click on the link to open it. Acrobat reader provides an option 
allowing you to save the file to your hard disk. Secondly, data for most tables 
and graphs can be downloaded as a CSV file by clicking on buttons for this 
purpose under the display of results in the main area of the page. Thirdly, in 
the Downloads subsection of the Voyages Database, links are provided to enable 
you to download the full set of variables in the 2008 edition of the 
Trans-Atlantic Slave Trade SPSS Database, the version of this database used for 
the 1999 CD-ROM, the codebook for SPSS versions, the selection of variables for 
the website in several formats, and a spreadsheet containing the basic 
calculations used to derive the interactive set of estimates in Assessing the 
Slave Trade.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (56, 11, 'What should I 
do if I find errors in how a variable or variables are coded for a particular 
voyage or set of voyages?', '<p>Correct them using the automatic entry data 
entry form in Contribute, the fourth subsection under “The Database”. When you 
receive a user name and password authorizing you to enter this part of the site, 
you will see that you are first asked to choose between three types of 
submissions. The second is “Edit an existing voyage.” It has two columns, on the 
left data as presently entered, on the right the correct data that you propose 
instead. For variables that are already correct, you just need to click on 
“copy.” A space is also provided for any notes about your revision of each 
variable. It is particularly important to provide full information about the 
sources used to identify mistakes.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (57, 11, 'How can I 
contribute new data on slave voyages to the website?', '<p>The “Contribute” 
subsection of the Voyages Database provides a data entry form designed to 
facilitate submission of new data. Guidelines are provided there on how to use 
it. In asking for a user name and password to enter this section, you will be 
put in contact with a specialist in the area and era of the slave trade in which 
you are interested who will help you with your contribution.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (58, 11, 'What should I 
do if I find two cases describing the same voyage?', '<p>In the automatic data 
entry form in Contribute, one type of submission is “Merge existing voyages.” It 
shows variables for two or three cases side-by-side for each case, allowing one 
to determine if they are duplicates. A word of caution: the same ship often made 
several voyages.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (59, 11, 'How do I make 
contributions to features of the website other than the databases (essays, 
images, bibliographies, links, documents)?', '<p>Rather than using the data 
entry form, contact <a href="mailto:voyages@emory.edu" 
shape="rect">voyages@emory.edu</a>.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (60, 12, 'What kinds of 
essays are published on the website?', '<p>Presently, the essays subsection of 
Understanding the Database contains three types of contributions: interpretative 
essays, vignettes or biographical sketches about individuals transported on 
slave ships, and a research note. We will periodically change the contents of 
this section, adding longer and shorter essays, notes, reports on archives, 
projects about the slaves, and in general any kind of text for which the 
Trans-Atlantic Slave Trade Database is a major source. Users are invited to 
submit manuscripts to <a href="mailto:voyages@emory.edu" 
shape="rect">voyages@emory.edu</a>.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (61, 13, 'What is the 
difference the main database and the estimates database?', '<p>Statistics in the 
...
INSERT INTO faqs (id, cat_id, question, answer) VALUES (62, 13, 'What does the 
command “Reset to default” do?', '<p>In Estimates, each of the boxes for setting 
...
default” in a box, initial settings are restored for all specifications.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (63, 13, 'Are embarkation 
regions in Estimates and the Voyages Database defined differently?', '<p>No. 
...
Mascarene islands, and Madagascar with Southeast Africa.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (64, 13, 'Are 
disembarkation regions in Estimates and the Voyages Database defined 
differently?', '<p>Yes. In the Voyages Database, the Caribbean forms one broad 
...
database: Europe, Africa, Brazil, and Mainland North America.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (65, 14, 'How are images 
linked to other sections of the <i>Voyages</i> website?', '<p>In the Images 
section itself, the caption indicates when an image is relevant to a particular 
voyage. When one clicks on the image to obtain a larger view with information 
about it, below the commentary on the right is a link to related voyages. 
Clicking on it takes you directly to details about the voyage in the Voyages 
Database. In addition to links <i>from</i> Images to other sections of the 
website, there are links from other sections like Essays (in Assessing the Slave 
Trade) <i>to</i> the Images section. One of the three tabs in voyage detail (the 
page with information on a voyage opened when the row where it appears in the 
List of voyages is clicked) is to “Related images.” </p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (66, 14, 'How does 
“Search for Images” (the query box in “Images”) function?', '<p>Thumbnails of 
images that match the search criteria (a key term, a period of time, or one of 
the categories into which the images are organized) will appear in the main part 
of the window. The user can click on any of them for a full size image and 
commentary.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (67, 14, 'What kinds of 
information are displayed when one clicks on the thumbnail of an image?', 
'<p>Each image includes a brief description of its historical relevance, the 
creator and location of the original work and its date of creation, and links to 
related voyages in The Database.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (68, 15, 'Why is the 
listing for the African Names Database entitled “Liberated Africans”?', 
'<p>Although Great Britain and the United States abolished the international 
slave trade in 1807, slave ships continued to transport Africans to places in 
the Americas where slavery continued to be practiced and it remained legal to 
import slaves. To suppress the traffic, the British signed treaties with various 
countries to establish courts of mixed (or joint) commission to adjudicate 
suspected slave ships stopped by its naval cruisers and liberate any slaves 
found on board. The names of these captives, spelled with the help of African 
interpreters, were entered into special registers along with identifying 
personal characteristics such as age, height, and gender.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (69, 15, 'How is the 
African Names Database related to the Trans-Atlantic Slave Trade database?', 
'<p>Almost all the slave vessels captured by British naval cruisers are already 
in the Trans-Atlantic Slave Trade Database (TSTD). The second variable in the 
African Names Database is the voyage identification number in the TSTD, the 
fourth variable is the ship’s name, and the sixth variable is the year of 
arrival at the port, in Havana or Sierra Leone, where the case of the captured 
slave ship was adjudicated. The TSTD provides information on where the slaves 
embarked in Africa and where they were intended to disembark in the Americas had 
the slave ships been allowed to complete their voyages.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (70, 15, 'How do I use 
the query box “Search for Africans” in the names database?', '<p>Information about 
the 67,000 liberated Africans in the Names database is organized in spreadsheet 
format in the main area of the page. Each African is assigned a unique 
identification number in the left-hand column. He or she is the basic unit of 
analysis, unlike the Trans-Atlantic Slave Trade Database where the basic unit is 
a slave voyage. The search criteria (African name, ship name, voyage ID, time 
frame, age, etc.) correspond with headers for the spreadsheet. By selecting a 
variable, one can first observe how many of the liberated Africans shared a 
certain characteristic (the number appearing after “Results” – for example, 
15,680 were boys) and then analyze variation within the variable – their 
distribution by age, height and origin, and their place of embarkation and 
disembarkation. Like the other databases of the website, this one permits the 
user to sort the values of any variable in clicking on its label, facilitating 
the detection and analysis of patterns.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (71, 16, 'Where do I find 
information on the website to put voyages into historical context?', '<p>Several 
resources are available on the Voyages website itself: essays and introductory 
maps in Assessing the slave trade, the chronology of key events in the history 
of the slave trade below the Estimates timeline, images in Resources, and the 
glossary with key terms used by historians of the slave trade. In addition, the 
list of Sources and links on the website, without pretending to be exhaustive, 
point the user towards some of the most important places beyond the website to 
look for information.</p>');

INSERT INTO faqs (id, cat_id, question, answer) VALUES (72, 17, 'How do I cite 
essays and texts found on the website?', '<p>That depends on the manual of style 
...
database found on the website?', '<p><i>The Chicago Manual of Style</i>’s “Quick 
Guide” also provides an example of how to cite an item in an online database. 
For specific output or data selections, users should cite the URL generated by 
“Create a link.” Pasting the URL into the website will always generate the same 
results.</p>');