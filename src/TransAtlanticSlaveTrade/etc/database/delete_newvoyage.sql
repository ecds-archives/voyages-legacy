-- Function: delete_newvoyage(integer)

-- DROP FUNCTION delete_newvoyage(integer);

CREATE OR REPLACE FUNCTION delete_newvoyage(integer)
  RETURNS boolean AS
$BODY$
DECLARE
	sid ALIAS FOR $1;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION delete_newvoyage(integer) OWNER TO tast;
