...
<h:form id="main">
	...
	<h:commandButton value="< No, go back" action="#{AdminSubmissionBean.rejectDeleteVoyage}"/>
	<h:commandButton value="Yes, proceed >" action="#{AdminSubmissionBean.deleteEditandMerge}"/>
