...
<h:form id="form">
	...
	<div id="help-section-title">
		...
		<tr>
			...
			<td class="demo-links">
				<a href="demo-overview.faces" class="demo-link-active">Voyages site overview</a>
				<a href="demo-search.faces">Voyages Database search</a>
			</td>
		</tr>
		</table>
	</div>
	...
	This video provides an introduction to the main sections of the site and how to navigate them.
	</div>
	...
	<div style="margin-left: auto; margin-right: auto; padding-top: 19px; width: 640px; background-color: Black; margin-top: 10px;">
		<object classid="clsid:02bf25d5-8c17-4b23-bc80-d3488abddc6b" width="640" height="496" codebase="http://www.apple.com/qtactivex/qtplugin.cab">
			<param name="src" value="demo-overview.mov">
			<param name="autoplay" value="false">
			<param name="controller" value="true">
			<embed src="demo-overview.mov" width="640" height="496" autoplay="false" controller="true" pluginspage="http://www.apple.com/quicktime/download/">
			</embed>
		</object>
	</div>
