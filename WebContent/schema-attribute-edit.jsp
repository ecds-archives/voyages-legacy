...
<f:view>
	<h:form>
		...
		<div class="content">
			...
			<div class="field"><h:inputText style="width: 200px;" value="#{AttributesBean.attributeName}" /></div>
	
			<div class="label">User label</div>
			<div class="field"><h:inputText style="width: 200px;" value="#{AttributesBean.attributeUserLabel}" /></div>
