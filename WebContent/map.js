...
// server
var map_tiles_server = "servlet/maptile";
...
function map_control_init()
{
	...
	*/
	...
	map_control = document.getElementById("map-control");
	map_control.style.display = "block";
	
	map_control_top_tools = document.getElementById("map-tools-top");
	if (map_control_top_tools) map_control_top_tools.style.position = "absolute";
	
	map_control_bottom_tools = document.getElementById("map-tools-bottom");
	if (map_control_bottom_tools) map_control_bottom_tools.style.position = "absolute";

	map_control_left_tools = document.getElementById("map-tools-left");
	if (map_control_left_tools) map_control_left_tools.style.position = "absolute";
	
	map_control_right_tools = document.getElementById("map-tools-right");
	if (map_control_right_tools) map_control_right_tools.style.position = "absolute";

	map_frame = document.getElementById("map-frm");
