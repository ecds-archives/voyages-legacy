			...
			<td id="about-right-column">
				<s:simpleBox>
					...
					<h1>History of the Project</h1>
						...
						scholars created a number of slave ship data sets, several of which the current authors have chosen to 
						recode from the primary sources rather than integrate into the present set. By the late 1980s, there were 
						...
						<p>The idea of creating a single multisource data set of trans-Atlantic slave voyages emerged from a 
						...
						first time, and beyond that, given the available Dutch, French, and Portuguese data, to collect a single data set for 
						...
						sets of published material available only in hard-copy form had been available for some time, and scholars volunteered 
						unpublished data as awareness of the project increased. In the course of the next three years, the project undertook three 
						...
						initiative was undertaken in Portuguese and Spanish language archives around the Atlantic basins to make good this deficiency. 
						...
						search interfaces for three different kinds of data, as well as estimates of the size and direction of the trade. It also 
						provides a range of ancillary material for educators including maps. Perhaps most important, the new site provides an opportunity 
						for researchers everywhere to continue to contribute their discoveries and correct errors in the data that they might find. After 
