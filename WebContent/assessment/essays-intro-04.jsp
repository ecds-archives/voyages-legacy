		...
		<tr>
			...
			<td id="essays-right-column">
				<s:simpleBox>
					...
					<a href="../database/voyage.faces?voyageId=46474">first slave voyage</a>
					...
					Cibao on Hispaniola emerging as a major purchaser. <a href="../database/voyage.faces?voyageId=29647">Cartagena</a>, in
					...
					Europe, and the slave system began <a href="intro-maps.faces#map4">two centuries of westward
