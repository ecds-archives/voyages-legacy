...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Overview of the slave trade out of Africa, 1500-1900" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_001_Slave_Trade_Overview.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_001_Slave_Trade_Overview_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="The Migration of sugar cultivation from Asia into the Atlantic" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_002_Migration_Sugar_Cultivation.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_002_Migration_Sugar_Cultivation_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Old World Slave Trade Routes in the Atlantic before 1759" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_003_Old_World_SlaveTrade.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_003_Old_World_SlaveTrade_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Wind and ocean currents of the Atlantic basins" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_004_Wind_currents.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_004_Wind_currents_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Major regions and ports involved in the transatlantic slave trade, all years" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_005_Atlantic_Basin.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_005_Atlantic_Basin_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Ports in the Atlantic where slave voyages were organized, all years" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_006_Europe_Overview.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_006_Europe_Overview_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Major coastal regions from which captives left Africa, all years" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_007_Africa_Overview.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_007_Africa_Overview_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Major regions where captives disembarked, all years" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_008_Americas_Overview.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_008_Americas_Overview_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
...
<div style="padding-top: 20px; ">
	<t:htmlTag value="td" styleClass="images-category-name">
		<h:outputText value="Volume and direction of the transatlantic slave trade from all African to all American regions" />
	</t:htmlTag>
	<t:htmlTag value="td" styleClass="images-category-link">
		<a href ="../newMaps/YP1_008A_Transatlantic.pdf" target="_blank">Click here for the map.</a>
	</t:htmlTag>
</div>
</t:htmlTag>
</t:htmlTag>
...
<td width="300" align="right"><img src = "../newMaps/YP1_008A_Transatlantic_preview.PNG" width="200px"></img></td>
</tr>
</table>
</t:htmlTag>
</div>
