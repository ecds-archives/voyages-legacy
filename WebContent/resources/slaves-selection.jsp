...
<s:expandableBoxSet expandedId="basic">
	...
	<s:expandableBox text="Contry of origin" boxId="origin">
	...
	<s:expandableBox text="Place of embaration and capture" boxId="places">

		<s:lookupCheckboxList
			id="r"
			items="#{SlavesTableBean.expPorts}"
			selectedValues="#{SlavesTableBean.selectedExpPorts}"
			expandedValues="#{SlavesTableBean.expandedExpPorts}" />
