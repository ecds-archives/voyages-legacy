...
session.setAttribute("test-map", "C:\\Documents and Settings\\jzich\\workspace\\tast\\etc\\gis\\test.map");
...
<head>
	...
	<script src="map-02.js" type="text/javascript" language="javascript"></script>
