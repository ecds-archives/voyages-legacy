...
<f:view>
	<h:form>
		...
		<h:commandLink action="#{CompoundAttributesBean.switchToVoyages}" value="Voyages"/> |
		<h:commandLink action="#{CompoundAttributesBean.switchToSlaves}" value="Slaves"/>
		
		<br>
		
		<h:dataTable value="#{CompoundAttributesBean.attributes}" var="attribute" border="1">
			<h:column>
				<f:facet name="header">
